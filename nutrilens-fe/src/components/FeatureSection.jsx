      ...
      <div className="feat-container">
        ...
        <div className="card-container">
          <div className="card-1">
            <img src="./icon/lightning-icon.png" alt="lightning-icon" />
          ...
          <div className="card-2 ">
            <img src="./icon/suggestion-icon.png" alt="suggestion-icon" />
